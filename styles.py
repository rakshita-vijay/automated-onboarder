...
@media (prefers-color-scheme: light) {
    [data-testid="stTextInput"] input {
        ...
        color: #111 !important;
        border: 1.5px solid #6c63ff !important; /* Light blue accent */
...
@media (prefers-color-scheme: light) {
    .stFileUploader {
        border: 2px dashed #6c63ff !important; /* Light blue accent */
        background: #fff !important;
...
@media (prefers-color-scheme: light) {
    ...
    [data-testid="stFileUploader"] div[data-testid="stFileUploaderDropzone"] + div {
        background-color: #f0f9ff !important; /* Light blue for file row */
        color: #111 !important;
        border: 1px solid #6c63ff !important; /* Light blue accent border */
...
@media (prefers-color-scheme: light) {
    .stButton>button {
        background: linear-gradient(90deg, #6c63ff 0%, #48bb78 100%) !important;
        color: #fff !important;
    ...
    .stButton>button:hover {
        background: linear-gradient(90deg, #48bb78 0%, #6c63ff 100%) !important;
        color: #fff !important;
    }
}
/* Dark Mode: Dark background, white text */
